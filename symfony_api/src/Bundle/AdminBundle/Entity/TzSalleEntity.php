...
class TzSalleEntity
{
     ...
     * @var string
     *
     * @ORM\Column(name="salle_nom", type="string", length=80, nullable=false)
     * @JMS\Groups({"salle_etude", "entite_juridique"})
     */
    private $nom;

    /**
     * @var \DateTime
     * @ORM\Column(name="salle_date_debut_occupation", type="datetime",nullable=true)
     */
    private $dateDebutOccupation;

    /**
     * @var \DateTime
     * @ORM\Column(name="salle_date_fin_occupation", type="datetime",nullable=true)
     */
