...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => ($this->targetDirs[3].'/src/Bundle/AdminBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Bundle/UserBundle/Entity')));

$b->addDriver($c, 'Bundle\\AdminBundle\\Entity');
$b->addDriver($c, 'Bundle\\UserBundle\\Entity');
...
$a->setEntityNamespaces(array('AdminBundle' => 'Bundle\\AdminBundle\\Entity', 'UserBundle' => 'Bundle\\UserBundle\\Entity'));
