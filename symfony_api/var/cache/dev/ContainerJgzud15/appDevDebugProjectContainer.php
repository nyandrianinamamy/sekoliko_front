...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->methodMap = array(
            ...
            'sekoliko.rest_listener' => 'getSekoliko_RestListenerService',
        ...
        $this->fileMap = array(
            ...
            'sekoliko_api.authentication_failure_listener' => 'getSekolikoApi_AuthenticationFailureListenerService.php',
            'sekoliko_api.authentication_success_listener' => 'getSekolikoApi_AuthenticationSuccessListenerService.php',
            'sekoliko_api.jwt_expired_listener' => 'getSekolikoApi_JwtExpiredListenerService.php',
            'sekoliko_api.jwt_invalid_listener' => 'getSekolikoApi_JwtInvalidListenerService.php',
            'sekoliko_api.jwt_not_found_listener' => 'getSekolikoApi_JwtNotFoundListenerService.php',
            ...
            'tz.exception_listener' => 'getTz_ExceptionListenerService.php',
            'tz.responses' => 'getTz_ResponsesService.php',
            ...
            'ws.tz_msg' => 'getWs_TzMsgService.php',
        );
        $this->privates = array(
            ...
            'sekoliko.rest_listener' => true,
            'sekoliko_api.authentication_failure_listener' => true,
            'sekoliko_api.authentication_success_listener' => true,
            'sekoliko_api.jwt_expired_listener' => true,
            'sekoliko_api.jwt_invalid_listener' => true,
            'sekoliko_api.jwt_not_found_listener' => true,
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/src/Bundle/CommunBundle/EventListener/RestListener.php';
            ...
            include_once $this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/EventListener/VersionListener.php';
            include_once $this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/Version/VersionResolverInterface.php';
            include_once $this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/Version/ChainVersionResolver.php';
            include_once $this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/Version/Resolver/QueryParameterVersionResolver.php';
            include_once $this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/Version/Resolver/HeaderVersionResolver.php';
            include_once $this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/Version/Resolver/MediaTypeVersionResolver.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('eqZRCs31Ed', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lCWJzpB4hC', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2JX3uuEqNI', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9OKiEbxolG', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wiYGdTu1U2', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener('kernel.exception', array(0 => function () {
            return ${($_ = isset($this->services['tz.exception_listener']) ? $this->services['tz.exception_listener'] : $this->services['tz.exception_listener'] = new \Bundle\CommunBundle\EventListener\ExceptionListener()) && false ?: '_'};
        ...
        $instance->addListener('lexik_jwt_authentication.on_authentication_success', array(0 => function () {
            return ${($_ = isset($this->services['sekoliko_api.authentication_success_listener']) ? $this->services['sekoliko_api.authentication_success_listener'] : $this->services['sekoliko_api.authentication_success_listener'] = new \Bundle\CommunBundle\EventListener\AuthentificationEventListener($this)) && false ?: '_'};
        }, 1 => 'onAuthenticationSuccessResponse'), 0);
        $instance->addListener('lexik_jwt_authentication.on_authentication_failure', array(0 => function () {
            return ${($_ = isset($this->services['sekoliko_api.authentication_failure_listener']) ? $this->services['sekoliko_api.authentication_failure_listener'] : $this->services['sekoliko_api.authentication_failure_listener'] = new \Bundle\CommunBundle\EventListener\AuthentificationEventListener($this)) && false ?: '_'};
        }, 1 => 'onAuthenticationFailureResponse'), 0);
        $instance->addListener('lexik_jwt_authentication.on_jwt_not_found', array(0 => function () {
            return ${($_ = isset($this->services['sekoliko_api.jwt_not_found_listener']) ? $this->services['sekoliko_api.jwt_not_found_listener'] : $this->services['sekoliko_api.jwt_not_found_listener'] = new \Bundle\CommunBundle\EventListener\JwtListener()) && false ?: '_'};
        }, 1 => 'onJWTNotFound'), 0);
        $instance->addListener('lexik_jwt_authentication.on_jwt_expired', array(0 => function () {
            return ${($_ = isset($this->services['sekoliko_api.jwt_expired_listener']) ? $this->services['sekoliko_api.jwt_expired_listener'] : $this->services['sekoliko_api.jwt_expired_listener'] = new \Bundle\CommunBundle\EventListener\JwtListener()) && false ?: '_'};
        }, 1 => 'onJWTExpired'), 0);
        $instance->addListener('lexik_jwt_authentication.on_jwt_invalid', array(0 => function () {
            return ${($_ = isset($this->services['sekoliko_api.jwt_invalid_listener']) ? $this->services['sekoliko_api.jwt_invalid_listener'] : $this->services['sekoliko_api.jwt_invalid_listener'] = new \Bundle\CommunBundle\EventListener\JwtListener()) && false ?: '_'};
        }, 1 => 'onJWTInvalid'), 0);
        $instance->addListener('kernel.response', array(0 => function () {
            return ${($_ = isset($this->services['sekoliko.rest_listener']) ? $this->services['sekoliko.rest_listener'] : $this->services['sekoliko.rest_listener'] = new \Bundle\CommunBundle\EventListener\RestListener()) && false ?: '_'};
    ...
    protected function getFosRest_FormatNegotiatorService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api', NULL, NULL, NULL, array()), array('priorities' => array(0 => 'json'), 'fallback_format' => 'html', 'methods' => NULL, 'attributes' => array(), 'stop' => false, 'prefer_extension' => '2.0'));
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/', NULL, NULL, NULL, array()), array('priorities' => array(0 => 'html'), 'fallback_format' => 'html', 'methods' => NULL, 'attributes' => array(), 'stop' => false, 'prefer_extension' => '2.0'));
    ...
    protected function getFosRest_Serializer_JmsHandlerRegistry_InnerService()
    {
        return $this->services['fos_rest.serializer.jms_handler_registry.inner'] = new \JMS\Serializer\Handler\LazyHandlerRegistry(new \Symfony\Component\DependencyInjection\ServiceLocator(array('fos_rest.serializer.form_error_handler' => function () {
            ...
            return ${($_ = isset($this->services['jms_serializer.datetime_handler']) ? $this->services['jms_serializer.datetime_handler'] : $this->services['jms_serializer.datetime_handler'] = new \JMS\Serializer\Handler\DateHandler('Y-m-d\\TH:i:sP', 'Europe/Moscow', true)) && false ?: '_'};
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(array('security.firewall.map.context.api' => function () {
            ...
            yield 'security.firewall.map.context.login' => ${($_ = isset($this->services['security.request_matcher.cvlthau']) ? $this->services['security.request_matcher.cvlthau'] : $this->services['security.request_matcher.cvlthau'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/users')) && false ?: '_'};
    ...
    /**
     * Gets the private 'sekoliko.rest_listener' shared service.
     *
     * @return \Bundle\CommunBundle\EventListener\RestListener
     */
    protected function getSekoliko_RestListenerService()
    {
        return $this->services['sekoliko.rest_listener'] = new \Bundle\CommunBundle\EventListener\RestListener();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/Bundle/AdminBundle/Resources/views'), 'Admin');
        $instance->addPath(($this->targetDirs[3].'/src/Bundle/AdminBundle/Resources/views'), '!Admin');
        $instance->addPath(($this->targetDirs[3].'/src/Bundle/UserBundle/Resources/views'), 'User');
        $instance->addPath(($this->targetDirs[3].'/src/Bundle/UserBundle/Resources/views'), '!User');
        $instance->addPath(($this->targetDirs[3].'/src/Bundle/CommunBundle/Resources/views'), 'Commun');
        $instance->addPath(($this->targetDirs[3].'/src/Bundle/CommunBundle/Resources/views'), '!Commun');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'AdminBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Bundle/AdminBundle'),
                ...
                'CommunBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Bundle/CommunBundle'),
                    'namespace' => 'Bundle\\CommunBundle',
                ),
                'FOSUserBundle' => array(
                    'parent' => NULL,
            ...
            case 'jwt_private_key_path': $value = ($this->targetDirs[3].'/app/config/JWT/private.pem'); break;
            case 'jwt_public_key_path': $value = ($this->targetDirs[3].'/app/config/JWT/public.pem'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AdminBundle' => 'Bundle\\AdminBundle\\AdminBundle',
                'UserBundle' => 'Bundle\\UserBundle\\UserBundle',
                'CommunBundle' => 'Bundle\\CommunBundle\\CommunBundle',
            ...
            'from_email_address' => 'tahiana.rakotonirina@netapsys.fr',
            'for_sender_name' => 'Techzara',
            'jwt_key_pass_phrase' => 'telma',
            'jwt_token_ttl' => 3600,
            'locale' => 'en',
            ...
            'fos_user.model.user.class' => 'Bundle\\UserBundle\\Entity\\TzUser',
            ...
            'lexik_jwt_authentication.pass_phrase' => 'telma',
